...
import com.zank.choiceness.adapter.PhotoSetAdapter;
...
import com.zank.choiceness.injector.components.DaggerPhotoSetComponent;
import com.zank.choiceness.injector.modules.PhotoSetModule;
import com.zank.choiceness.widget.PhotoViewPager;
...
public class PhotoSetActivity extends BaseActivity<IBasePresenter> implements IPhotoSetView {
    ...
    public static void launch(Context context, String newId) {
        ...
        intent.putExtra(PHOTO_SET_KEY, newId);
    ...
    protected void initInjector() {
        ...
        DaggerPhotoSetComponent.builder()
                .photoSetModule(new PhotoSetModule(mPhotoSetId, this))
                .build()
                .inject(this);
    }
